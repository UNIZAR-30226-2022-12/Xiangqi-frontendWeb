<template>
    ...
    <div class="surface-section section p-6 text-center"> <!--text-center px-2 py-4 md:px-3 lg:px-4-->
		...
		<div class="surface-section section mt-4 p-6 text-center">
			<div class="grid">
				<div class="col-12 md:col-6 lg:col-3 mb-4 px-5 text-center">
					...
					<div class="text-900 mb-3 font-medium text-center">Cumpleaños</div>
					<span class="text-700 text-sm line-height-3">{{perfil.birthday}}</span>
				</div>
				<div class="col-12 md:col-6 lg:col-2 mb-4 px-5 text-center">
					<span class="p-3 shadow-2 mb-3 inline-block surface-50 text-center" style="border-radius: 1rem">
					...
					<div class="text-900 mb-2 font-medium text-centerw-full">Puntos</div>
					<span class="text-700 text-sm line-height-3 w-full">{{perfil.points}} puntos</span>
				</div>
				<div class="col-12 md:col-6 lg:col-2 mb-4 px-5 text-center">
					<span class="p-3 shadow-2 mb-3 inline-block surface-50 text-center" style="border-radius: 1rem">
						<font-awesome-icon class="text-4xl text-primary" icon="calendar" />
					</span>
					<div class="text-900 mb-3 font-medium text-center w-full">Usuario desde</div>
					<span class="text-700 text-sm line-height-3 w-full">{{perfil.registerDate}}</span>
				</div>
				<div class="col-12 md:col-6 lg:col-2 mb-4 px-5 text-center">
					<span class="p-3 shadow-2 mb-3 inline-block surface-50 text-center" style="border-radius: 1rem">
						<font-awesome-icon class="text-4xl text-primary" icon="arrow-trend-up" />
					</span>
					<div class="text-900 mb-3 font-medium text-center w-full">Clasificacion</div>
					<span class="text-700 text-sm line-height-3 w-full">Puesto {{perfil.range}}</span>
				</div>
				<div class="col-12 md:col-6 lg:col-3 mb-4 px-5 text-center">
					<span class="p-3 shadow-2 mb-3 inline-block surface-50 text-center" style="border-radius: 1rem">
						<font-awesome-icon class="text-4xl text-primary" icon="user-group" />
					</span>
					<div class="text-900 mb-3 font-medium text-center w-full">Numero de amigos</div>
					<span class="text-700 text-sm line-height-3 w-full">Amigos {{perfil.nFriends}}</span>
				</div>
			</div>
		</div>
	</div>
